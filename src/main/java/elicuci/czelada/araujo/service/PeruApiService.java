...
public class PeruApiService {
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK
                ...
                dto.setApellidoPaterno(
                        (String) body.get("apellido_paterno")
                );

                dto.setApellidoMaterno(
                        (String) body.get("apellido_materno")
                );
            ...
            throw new RuntimeException(
                    "No se pudo consultar el DNI: " + e.getMessage()
            );
        }
    }
    ...
    public PeruApiRucDTO consultarRuc(String ruc) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "No se pudo consultar el RUC: " + e.getMessage()
            );
        }
    }
}